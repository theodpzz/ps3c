...
Pretrain weights for Step 1 and Step 2, as well as the per-class final predicted probabilities, are provided in the [🤗 HuggingFace project repository](https://huggingface.co/theodpzz/ps3c).
