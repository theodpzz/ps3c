...
from step2.src.modules.dataset import getTrainDataset
from step2.src.modules.dataloader import prepare_dataloader

from step2.src.models.model import Model
from step2.src.modules.optimizer import get_optimizer_scheduler
from step2.src.modules.utils import make_output_dir, parse_yaml
from step2.src.modules.figures import plot_losses
...
class Trainer:
    ...
    def _run_batch(self, i, volumes, labels):

        # forward pass
        _, loss_forward = self.model(volumes, labels)
    ...
    def step_train(self):
        ...
        with tqdm(total=len(self.dataloader)) as pbar:
            for i, data in enumerate(self.dataloader):
                ...
                loss   = self._run_batch(i, volumes, labels)
                del volumes, labels
